...
//        
//    }
//    Car(string t,int s,string n,int p){        //parameterized constructor
//        type=t;
//        name=n;
//        price=p;
//        seats=s;
...
//
//int main(){
//    Car c1("private car",5,"toyota",900000);     //peremeterized constructor allows it
////    c1.name="toyota";
////    c1.price=900000;
////    c1.seats=5;
////    c1.type="private car";
...
//    Car c3;                  //default constructor allows it to run like this
//    c3.name="Range Rover";
//    c3.price=15000000;
//    c3.seats=7;
//    c3.type="SUV";
